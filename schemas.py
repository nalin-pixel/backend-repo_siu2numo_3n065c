...
# Creative agency onboarding lead schema
class Creativelead(BaseModel):
    """
    Onboarding leads from the website
    Collection name: "creativelead"
    """
    ...
    goals: Optional[str] = Field(None, description="Project goals / success criteria")
